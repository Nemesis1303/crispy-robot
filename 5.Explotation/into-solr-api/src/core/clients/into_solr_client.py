"""
This module provides a specific class for handeling the Solr API responses and requests of the Into-Solr-Service.
...
from src.core.clients.external.into_tools_client import IntoToolsClient
...
class IntoSolrClient(SolrClient):
    ...
    def __init__(self,
        ...
        # Create IntoToolsClient to send requests to the IntoTools API
        self.into_tooler = IntoToolsClient(logger)
    ...
    def do_Q5(
        ...
        if thetas == -1:
            ...
            inf_resp = self.into_tooler.get_thetas(text_to_infer=lemmas,
        ...
        q5 = self.querier.customize_Q5(
            model_name=model_col, thetas=thetas, start=start, rows=rows)
    ...
    def do_Q14(self,
        ...
        # 3. Make request to IntoTools API to get thetas of text_to_infer
        # Get text (lemmas) of the document so its thetas can be inferred
        lemmas_resp = self.into_tooler.get_lemmas(text_to_lemmatize=text_to_infer, lang="es")
    ...
    def do_Q21(
        ...
        start:int,
        rows:int,
        embedding_model:str = "paraphrase-distilroberta-base-v2",
        lang:str = "es",
    ) -> Union[dict,int]:
        """
        Executes query Q21.
        ...
        resp = self.into_tooler.get_embedding(
